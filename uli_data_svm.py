...
for i in range(1,11):
	...
	for rep in range(10):
		...
		clusterer = hdbscan.HDBSCAN(min_samples=3*d*d, min_cluster_size=3*d*d)
		...
		regularization_constants = range(-4,11,2)
		# regularization_constants = range(0,3,2)

		degrees = range(1,10,2)
...
for i in range(train_means.shape[0]):
	...
	plt.savefig('svm_results/poly_f_{}_hdbscan.png'.format(i))
